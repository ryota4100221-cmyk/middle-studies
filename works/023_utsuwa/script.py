...
LMIN = -0.66   # 🔴 #59：振幅が足りず動き量0.53だった（下限0.62）
LMAX =  0.86   # 🔴 #59：器の内側だけで上下しても画面が変わらず動き量0.54。縁の高さまで上げる
...
POOL_LO = 0.02           # 空のときの発光倍率（満ち=1.0）
LIGHT_LO = 0.4           # 空のときの点光源エネルギー（満ち=LIGHT_E）
